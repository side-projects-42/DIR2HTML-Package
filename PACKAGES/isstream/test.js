...
[
  ...
  test(
    false,
    "non-stream / primitive: " +
      (JSON.stringify(o) || (o && o.toString()) || o),
    o
  );
});
...
testReadable(
  true,
  "ReadableStream10.Readable",
  new ReadableStream10.Readable()
);
testReadable(
  false,
  "ReadableStream10.Writable",
  new ReadableStream10.Writable()
);
testReadable(true, "ReadableStream10.Duplex", new ReadableStream10.Duplex());
testReadable(
  true,
  "ReadableStream10.Transform",
  new ReadableStream10.Transform()
);
testReadable(
  true,
  "ReadableStream10.PassThrough",
  new ReadableStream10.PassThrough()
);

testReadable(
  true,
  "ReadableStream11.Readable",
  new ReadableStream11.Readable()
);
testReadable(
  false,
  "ReadableStream11.Writable",
  new ReadableStream11.Writable()
);
testReadable(true, "ReadableStream11.Duplex", new ReadableStream11.Duplex());
testReadable(
  true,
  "ReadableStream11.Transform",
  new ReadableStream11.Transform()
);
testReadable(
  true,
  "ReadableStream11.PassThrough",
  new ReadableStream11.PassThrough()
);
