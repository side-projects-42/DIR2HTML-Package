...
- `help` _(object)_ - The help text used with `--help`
- `showHelp([code=0])` _(function)_ - Show the help text and exit with `code`
...
_(Still supported, but you should use a template literal instead.)_
