...
!(function (e, t) {
    ...
    q = function (n, e) {
      ...
      var r = {
        replace: function (e, t) {
          return (
            (t = (t = t.source || t).replace(p, "$1")), (n = n.replace(e, t)), r
          );
        },
        getRegex: function () {
  ...
  (C.def = q(C.def)
    ...
    (C.bullet = /(?:[*+-]|\d{1,9}\.)/),
    (C.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/),
    (C.item = q(C.item, "gm").replace(/bull/g, C.bullet).getRegex()),
    (C.list = q(C.list)
      .replace(/bull/g, C.bullet)
      .replace(
        "hr",
        "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))"
      )
    ...
    (C.paragraph = q(C._paragraph)
      ...
      .replace("tag", C._tag)
      .getRegex()),
    (C.blockquote = q(C.blockquote)
      .replace("paragraph", C.paragraph)
      .getRegex()),
    (C.normal = L({}, C)),
    (C.gfm = L({}, C.normal, {
      nptable:
    ...
    (C.pedantic = L({}, C.normal, {
      ...
      heading: /^ *(#{1,6}) *([^\n]+?) *(?:#+ *)?(?:\n+|$)/,
      fences: Z,
      paragraph: q(C.normal._paragraph)
        .replace("hr", C.hr)
        .replace("heading", " *#{1,6} *[^\n]")
        .replace("lheading", C.lheading)
        .replace("blockquote", " {0,3}>")
        .replace("|fences", "")
        .replace("|list", "")
        .replace("|html", "")
  ...
  (O.em = q(O.em)
    ...
    (O.link = q(O.link)
      ...
      .getRegex()),
    (O.reflink = q(O.reflink).replace("label", O._label).getRegex()),
    (O.normal = L({}, O)),
    (O.pedantic = L({}, O.normal, {
  ...
  var D = { block: C, inline: O },
      ...
      function n(e) {
        (this.tokens = []),
          ...
          this.options.pedantic
            ? (this.rules = j.pedantic)
            : this.options.gfm && (this.rules = j.gfm);
      }
      n.lex = function (e, t) {
        ...
        (e.token = function (e, t) {
          ...
          for (e = e.replace(/^ +$/gm, ""); e; )
            if (
              ...
              for (e = e.substring(s[0].length), p = 0; p < a.align.length; p++)
                /^ *-+: *$/.test(a.align[p])
                  ? (a.align[p] = "right")
                  : /^ *:-+: *$/.test(a.align[p])
                  ? (a.align[p] = "center")
              ...
              for (p = 0; p < a.cells.length; p++)
                a.cells[p] = T(a.cells[p], a.header.length);
              this.tokens.push(a);
                ...
                (c = (a = s[p]).length),
                  ~(a = a.replace(/^ *([*+-]|\d+\.) */, "")).indexOf("\n ") &&
                    ...
                    (a = this.options.pedantic
                      ? a.replace(/^ {1,4}/gm, "")
                      : a.replace(new RegExp("^ {1," + c + "}", "gm"), ""))),
                  p !== f - 1 &&
                    ((l = j.bullet.exec(s[p + 1])[0]),
                    (1 < i.length
                      ? 1 === l.length
    ...
    K = (function () {
      ...
      return (
        (e.output = function (e) {
          for (var t, n, r, s, i, l, a = ""; e; )
            if ((i = this.rules.escape.exec(e)))
              (e = e.substring(i[0].length)), (a += J(i[1]));
              ...
              (e = e.substring(i[0].length)),
                (a += this.renderer.codespan(J(i[2].trim(), !0)));
              ...
              if ((i = this.rules.text.exec(e)))
                (e = e.substring(i[0].length)),
                  this.inRawBlock
                    ...
                    : (a += this.renderer.text(J(this.smartypants(i[0]))));
              else if (e)
                throw new Error("Infinite loop on byte: " + e.charCodeAt(0));
            } else {
        ...
        (e.mangle = function (e) {
          ...
          for (var t, n = e.length, r = "", s = 0; s < n; s++)
            (t = e.charCodeAt(s)),
    ...
    te = (function () {
      ...
      return (
        (e.parse = function (e) {
          (this.inline = new K(e.links, this.options)),
            (this.inlineText = new K(
              e.links,
              Y({}, this.options, { renderer: new Q() })
            )),
          ...
          switch (this.token.type) {
            ...
            case "heading":
              return this.renderer.heading(
                ...
                this.token.depth,
                ee(this.inlineText.output(this.token.text)),
                this.slugger
              );
            case "code":
            ...
            case "table":
              ...
              for (
                ...
                for (n = this.token.cells[t], r = "", s = 0; s < n.length; s++)
                  r += this.renderer.tablecell(this.inline.output(n[s]), {
                    header: !1,
            ...
            case "list_start":
              e = "";
              for (
                var l = this.token.ordered, a = this.token.start;
  ...
  function oe(t, l, a) {
    ...
    try {
      return (
        (l = ne({}, oe.defaults, l || {})), re(l), te.parse(B.lex(t, l), l)
      );
    } catch (e) {
      if (
        ((e.message +=
          "\nPlease report this to https://github.com/markedjs/marked."),
        (l || oe.defaults).silent)
      )
        return (
          "<p>An error occurred:</p><pre>" + se(e.message + "", !0) + "</pre>"
        );
      throw e;
    }
  }
