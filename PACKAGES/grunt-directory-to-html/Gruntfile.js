  ...
  grunt.initConfig({
    ...
    to_html: {
      ...
      module_directory_option: {
        ...
        files: {
          "tmp/index4.html":
            "test/fixtures/module_directory_option/**/index.html",
        },
      },
      ...
      template_option: {
        options: {
          template: grunt.file.read(
            "test/fixtures/templates/test_template.jade"
          ),
        },
        files: {
      ...
      json_data: {
        options: {
          template: grunt.file.read(
            "test/fixtures/templates/template_with_random_data.jade"
          ),
        },
        files: {
      ...
      title_option: {
        ...
        files: {
          "tmp/index10.html":
            "test/fixtures/generate_page_option/**/index.html",
        },
      },
      stylesheet_option: {
        options: {
      ...
      use_filename_as_title_option: {
        ...
        files: {
          "tmp/index13.html":
            "test/fixtures/use_filename_as_title_option/**/*.html",
        },
      },
      dashes_for_folder_name: {
        files: {
          "tmp/index12.html":
            "test/fixtures/dashes-in-folder-name/**/index.html",
        },
      },
    },
