...
test("long boolean", function (t) {
  t.same(optimist.parse(["--bool"]), { bool: true, _: [], $0: $0 });
  t.end();
});
...
test("long capture sp", function (t) {
  t.same(optimist.parse(["--pow", "xixxle"]), { pow: "xixxle", _: [], $0: $0 });
  t.end();
});
...
test("no", function (t) {
  t.same(optimist.parse(["--no-moo"]), { moo: false, _: [], $0: $0 });
  t.end();
});
...
test("boolean groups", function (t) {
  var parse = optimist(["-x", "-z", "one", "two", "three"]).boolean([
    "x",
    "y",
    "z",
  ]).argv;
...
test("multiAlias", function (t) {
  var argv = optimist(["-f", "11", "--zoom", "55"]).alias("z", [
    "zm",
    "zoom",
  ]).argv;
  t.equal(argv.zoom, 55);
