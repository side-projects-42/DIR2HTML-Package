...
exports.usage =
  "Invokes `" + (win ? "msbuild" : "make") + "` and builds the module";
...
function build(gyp, argv, callback) {
  ...
  function findSolutionFile() {
    glob("build/*.sln", function (err, files) {
      ...
      if (files.length === 0) {
        return callback(
          new Error('Could not find *.sln file. Did you run "configure"?')
        );
      }
  ...
  function findMsbuild() {
    ...
    var cmd =
      'reg query "HKLM\\Software\\Microsoft\\MSBuild\\ToolsVersions" /s';
  ...
  function doBuild() {
    ...
    if (win) {
      ...
      var p =
        archLower === "x64" ? "x64" : archLower === "arm" ? "ARM" : "Win32";
