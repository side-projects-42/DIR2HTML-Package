...
test("test process release - process.release ~ iojs@3.2.24", function (t) {
  ...
  var release = processRelease([], { opts: {} }, "v3.2.24", {
    name: "io.js",
    headersUrl:
      "https://iojs.org/download/release/v3.2.24/iojs-v3.2.24-headers.tar.gz",
  });
...
test("test process release - process.release ~ iojs@3.2.11 +libUrl32", function (t) {
  ...
  var release = processRelease([], { opts: {} }, "v3.2.11", {
    name: "io.js",
    headersUrl:
      "https://iojs.org/download/release/v3.2.11/iojs-v3.2.11-headers.tar.gz",
...
test("test process release - process.release ~ iojs@3.2.101 +libUrl64", function (t) {
  ...
  var release = processRelease([], { opts: {} }, "v3.2.101", {
    name: "io.js",
    headersUrl:
      "https://iojs.org/download/release/v3.2.101/iojs-v3.2.101-headers.tar.gz",
...
test("test process release - process.release ~ node@4.1.23 --dist-url=https://foo.bar/baz", function (t) {
  ...
  var release = processRelease(
    [],
    { opts: { "dist-url": "https://foo.bar/baz" } },
    "v4.1.23",
    {
      name: "node",
      headersUrl: "https://nodejs.org/dist/v4.1.23/node-v4.1.23-headers.tar.gz",
...
test("test process release - process.release ~ frankenstein@4.1.23", function (t) {
  ...
  var release = processRelease([], { opts: {} }, "v4.1.23", {
    name: "frankenstein",
    headersUrl:
      "https://frankensteinjs.org/dist/v4.1.23/frankenstein-v4.1.23-headers.tar.gz",
  });
  ...
  t.deepEqual(release, {
    ...
    libUrl32:
      "https://frankensteinjs.org/dist/v4.1.23/win-x86/frankenstein.lib",
    libUrl64:
      "https://frankensteinjs.org/dist/v4.1.23/win-x64/frankenstein.lib",
...
test("test process release - process.release ~ frankenstein@4.1.23 --dist-url=http://foo.bar/baz/", function (t) {
  ...
  var release = processRelease(
    [],
    { opts: { "dist-url": "http://foo.bar/baz/" } },
    "v4.1.23",
    {
      name: "frankenstein",
      headersUrl:
        "https://frankensteinjs.org/dist/v4.1.23/frankenstein-v4.1.23.tar.gz",
    }
  );
  ...
  t.deepEqual(release, {
    ...
    tarballUrl:
      "http://foo.bar/baz/v4.1.23/frankenstein-v4.1.23-headers.tar.gz",
...
test("test process release - process.release ~ node@4.0.0-rc.4", function (t) {
  ...
  var release = processRelease([], { opts: {} }, "v4.0.0-rc.4", {
    name: "node",
    headersUrl:
      "https://nodejs.org/download/rc/v4.0.0-rc.4/node-v4.0.0-rc.4-headers.tar.gz",
  });
